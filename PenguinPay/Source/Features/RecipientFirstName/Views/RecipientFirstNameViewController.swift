//
//  RecipientFirstNameViewController.swift
//  PenguinPay
//
...
class RecipientFirstNameViewController: UIViewController {
    ...
    private var viewModel: RecipientFirstNameViewModelProtocol
    
    init(viewModel: RecipientFirstNameViewModelProtocol) {
...
extension RecipientFirstNameViewController: UITextFieldDelegate {
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        guard let unwrappedText = textField.text else { return textField.resignFirstResponder() }
        viewModel.didFillFirstName(unwrappedText)
        return textField.resignFirstResponder()
    }
    
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        return viewModel.validateFirstName(string)
    }
}
